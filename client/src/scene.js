...
export function createScene(canvas) { //generates scene objects 
    ...
    window.addEventListener('resize', () => { // event listener listening in on window resize to change the camera and renderer dimensions 
    ...
    window.addEventListener('dblclick', () => { //adds an event listener that on double click toggles fullscreen. need to remove this probably its annoying
