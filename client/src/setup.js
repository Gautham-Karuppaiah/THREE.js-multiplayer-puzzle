...
export async function setupUI(onStart) {
    ...
    imagePicker.addEventListener("change", (event) => {
        //sets up event listener listening for change in button indicated file has been uploaded
    ...
    startButton.addEventListener("click", () => {
        //adds event listener listening on values being entered or selected in the col and row selection boxes
